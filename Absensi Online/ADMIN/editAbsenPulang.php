...
if(isset($_POST['simpanJamPulang'])){

    if(simpanJamPulang($_POST)>0){
            echo "<script>
                    ...
                    <form class="kelas" method="post" action="">
                        ...
                        <div class="potition">
                            <div class="input">
                                ...
                                <label for="jam_pulang_awal">Jam Mulai</label>
                            </div>
                                <select name="jam_pulang_awal" id="jam_pulang_awal">
                                <option><?php echo $jam_pulang['jam_pulang_awal'] ?></option>
                                    <?php
                        ...
                        <div class="potition">
                            <div class="input">
                                <span><i class="far fa-clock"></i></span>
                                <label for="jam_pulang_akhir">Jam selesai</label>
                            </div>
                                <select name="jam_pulang_akhir" id="jam_pulang_akhir">
                                <option><?php echo $jam_pulang['jam_pulang_akhir'] ?></option>
                                    <?php
                                        for($jam = 1; $jam<=24; $jam++){     
                                    ?>
                                        <option value="<?php echo $jam; ?>"><?php echo $jam; ?></option>    
                        ...
                        <div class="btn-edit">
                            ...
                            <input class="button simpan" type="submit" name="simpanJamPulang" value="Simpan">
                        </div>
                    </form>
                </div>
            </div>
